...
const getOrganisationDetails =
  (payload: { _id: string }) => (axiosInstance: AxiosInstance) =>
...
const getOrganisationList = (payload: any) => (axiosInstance: AxiosInstance) =>
...
const createOrganisation = (payload: any) => (axiosInstance: AxiosInstance) =>
